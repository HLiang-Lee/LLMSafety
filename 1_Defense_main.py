...
def BenchTest(model_name, lang_type="zh", context_lang="zh", max_new_tokens=500, phase="dev_JailbreakBench",dataset_name="JailbreakBench"):
    ...
    print("[Info] The ASR is {:.2f}%".format(asr*100))
